  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Kontak</h2>
          <p>Kontak ini diberikan dalam rangka memudahkan komunikasi kepada Admin dan takmir guna laporan infak, memberikan infak, dan lain sebagainya.</p>
        </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="phone">
                ...
                <h4>Dwiki Rasya Rahadian (Takmir)</h4>
                <p>+62 855-7070-4480</p>
              </div>
              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Valentino Yoss Mahendra (Bendahara)</h4>
                <p>+62 822-4567-7790</p>
              </div>
              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Muhammad Khabib Ikhwanudin (Admin)</h4>
                <p>+62 857-0203-2342</p>
              </div>
            </div>
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Bank Republik Indonesia</h4>
                <p class="mb-0">7000 1984 90</p>
                <p>a.n. Muhammad Khabib Ikhwanudin</p>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Sukoharjo<br>
              Indonesia <br><br>
              <strong>Phone:</strong> +62 877-6554-7020<br>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#rekap">Rekap Bulanan</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#kegiatan">Kegiatan</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#saldo">Saldo</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#laporan">Laporan Kas</a></li>
